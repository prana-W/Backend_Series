...
const app = express();
const path = require('path'); // For app.set(), which is required from views
...
const cookieParser = require('cookie-parser'); // To read cookies passed from backend to client
